    ...
    return (
      <div className="relative w-full max-w-[240px] aspect-square">
        <svg viewBox="0 0 100 100" className="w-full h-full stroke-primary fill-none stroke-[1.5]" strokeLinecap="round" strokeLinejoin="round">
          ...
          <motion.path d="M40,20 L40,60 L20,80" className="stroke-primary/30 stroke-[1] stroke-dasharray-[4,4]" variants={draw} initial="hidden" animate="visible" />
          <motion.path d="M40,60 L100,60" className="stroke-primary/30 stroke-[1] stroke-dasharray-[4,4]" variants={draw} initial="hidden" animate="visible" />
        </svg>
    ...
    return (
      <div className="relative w-full max-w-[240px] aspect-square">
        <svg viewBox="0 0 100 100" className="w-full h-full stroke-primary fill-none stroke-[1.5]" strokeLinecap="round" strokeLinejoin="round">
          ...
          <motion.path d="M40,30 L40,60 L20,80" className="stroke-primary/30 stroke-[1] stroke-dasharray-[4,4]" variants={draw} initial="hidden" animate="visible" />
          <motion.path d="M40,60 L100,60" className="stroke-primary/30 stroke-[1] stroke-dasharray-[4,4]" variants={draw} initial="hidden" animate="visible" />
        </svg>
